    ...
    <div class="container-fluid">
        ...
        <!-- 搜索框 -->
 		<div class="row" style="margin-bottom: 10px;">
			<form class="form-inline" autocomplete="off" action="notice">
			...
			<div class="col-md-6" style="text-align: right;">
				...
				<ul class="pagination">
					...
					<c:choose>
						...
						<c:otherwise>
							<li><a href="notice?method=showInfo&pageNo=${pageBean.pageNo-1}&keyword=${keyword}">&laquo;</a></li>
						</c:otherwise>
					</c:choose>
					<!-- 补全页码 -->
					<c:forEach begin="1" end="${pageBean.totalPage}" var="i">
						...
						<c:choose>
							<c:when test="${i == pageBean.pageNo}">
								<li class="active"><a href="notice?method=showInfo&pageNo=${i}&keyword=${keyword}">${i}</a></li>
							</c:when>
							<c:otherwise>
								<li><a href="notice?method=showInfo&pageNo=${i}&keyword=${keyword}">${i}</a></li>
							</c:otherwise>
						</c:choose>
					</c:forEach>
					<!-- 处理下一页的操作 -->
					<c:choose>
						...
						<c:otherwise>
							<li>
							<a href="notice?method=showInfo&pageNo=${pageBean.pageNo+1}&keyword=${keyword}">&raquo;</a></li>
						</c:otherwise>
					</c:choose>
				</ul>
				</nav>
