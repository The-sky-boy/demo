...
<body>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12"><h2>更新公告</h2></div>
        </div>
        <!-- 数据表单 -->
        <div class="row">
            <form action="notice" class="col-xs-12" autocomplete="off">
                ...
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td style="text-align: left">
                        	<div class="input-group date">
                        		<input type="text" name="pub_time" class="form-control" value="${notice.pub_time}" placeholder="请选择发布时间">
                        ...
                        <td style="text-align: left">
                        	<div class="input-group date">
                        		<input type="text" name="expire_time" class="form-control" value="${notice.expire_time}" placeholder="请选择截至时间">
	                    		<span class="input-group-addon">
	                    			<span class="glyphicon glyphicon-calendar"></span>
	                			</span>
                        	</div>
                    ...
                    <tr>
                        <td>主题</td>
                        <td style="text-align: left"><input type="text" name="subject" class="form-control" value="${notice.subject}" placeholder="请填写公告主题"></td>
                        <td>通知范围</td>
                        <td style="text-align: left">
                            <select name="receive_id" class="form-control">
                                <option value="0">全部</option>
                                <c:forEach items="${depts}" var="dept">
                                	<option value="${dept.department_id}"<c:if test="${dept.department_id==notice.receive_id}">selected</c:if>>${dept.department_name}</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
